...
## $L^1$ and $L^2$ Norms {.smaller .crunch-title .crunch-math .crunch-ul .title-12}
...
$$
\boldsymbol\beta^*_{\text{ridge}} = \argmin_{\boldsymbol\beta}\left[ \frac{1}{N}\sum_{i=1}^{N}(\widehat{y}_i(\boldsymbol\beta) - y_i)^2 + \overbrace{\lambda}^{\mathclap{\text{Penalty}}} \| \boldsymbol\beta \|_{2}^{2} \right]
$$
