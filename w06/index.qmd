...
| | Start | End | Topic |
|:- |:- |:- |:- |
| **Lecture** | 6:30pm | 6:50pm | [Recap / Clarification &rarr;](#roadmap) |
| | 6:50pm | 7:00pm | [CV as "Subroutine" for Model Selection &rarr;](#a-non-linear-data-generating-process-(dgp)) |
| | 7:00pm | 7:20pm | 
...
## Contractual Obligation: "Stepwise" Model Selection

## Way Cooler and More Useful: *Automatic* Model Selection

* Ridge Regression
* Lasso
* Elastic Net

## Regularized Regression (Finally!) {.smaller}

Ridge Regression:

$$
\boldsymbol\beta^*_{\text{ridge}} = \argmin_{\beta}\left[ \frac{1}{N}\sum_{i=1}^{N}(\widehat{y}_i(\boldsymbol\beta) - y_i)^2 + \lambda \| \boldsymbol\beta \|_{2}^{2} \right]
$$
...
$$
\boldsymbol\beta^*_{\text{EN}} = \argmin_{\beta}\left[ \frac{1}{N}\sum_{i=1}^{N}(\widehat{y}_i(\boldsymbol\beta) - y_i)^2 + \lambda_2 \| \boldsymbol\beta \|_{2}^{2} + \lambda_1 \| \boldsymbol\beta \|_{1} \right]
$$
...
## Week 7 Preview: Basis Functions
